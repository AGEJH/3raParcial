...
void encontrarNumero(int buscar);
...
void buscarNumero(int buscar){
	...
	if(buscar==6)
	{
		printf("encontrar en el nivel 1 ");
	}
	else{
		if(buscar==5)
		{
			printf("encontrar en el nivel 2 ");
		}
		else{
			if(buscar==11)
			{
				...
				if(buscar==4)
				{
					printf("encontrar en el nivel 3 ");
				}
				else{
					if(buscar==8)
					{
						...
						if(buscar==12)
						{
							printf("encontrr en el nivel 3");
						}
						else{
							if(buscar==3)
							{
								printf("encontrar en el nivel 4 ");
							}
							else{
								if(buscar==9)
								{
